...
**Remediation:** Verification IDs now use a 12-hex-char suffix generated by SecureRandom (48 bits / ~2.8×10^14 combinations). Existing IDs remain valid; new uploads are unguessable. Collision retry with 5 attempts. Test verifies format and uniqueness across 50 generations.
